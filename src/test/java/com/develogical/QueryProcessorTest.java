...
public class QueryProcessorTest {
    ...
    public void fibonacciSequence() throws Exception {
        assertThat(queryProcessor.process("71ba53e0: what is the 3rd number in the Fibonacci sequence"), is("2"));
    }
}
...
//20what is the 18th number in the Fibonacci sequence" host=javawebdb.herokuapp.com request_id=477de8d3-99f9-44fc-899a-a9e056012692 fwd="34.254.146.190" dyno=web.1 connect=0ms service=2ms status=200 bytes=173 protocol=http
//        2022-04-07T15:09:36.417772+00:00 heroku[router]: at=info method=GET path="/api?q=a9617480: who played James Bond in the film Dr No" host=javawebdb.herokuapp.com request_id=48405648-80bd-45bf-bf2d-e206a2dc801b fwd="34.254.146.190" dyno=web.1 connect=0ms service=1ms status=200 bytes=186 protoc